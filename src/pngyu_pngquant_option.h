...
public:
  ...
  void set_ncolors(const int n) { m_ncolors = n; }

  int get_ncolors() const { return m_ncolors; }

  void set_speed(const int speed) { m_speed = speed; }

  int get_speed() const { return m_speed; }

  void set_force_overwrite(const bool b) { m_force_overwrite = b; }

  bool get_force_overwrite() const { return m_force_overwrite; }

  void set_ie6_alpha_support(const bool b) { m_ie6_alpha_support = b; }

  bool get_ie6_frilendly() const { return m_ie6_alpha_support; }
  ...
  void set_timeout_ms(const int timeout_ms) { m_timeout_ms = timeout_ms; }
...
inline bool operator!=(const pngyu::PngquantOption &o1,
  ...
  return o1.m_out_suffix != o2.m_out_suffix || o1.m_ncolors != o2.m_ncolors ||
         ...
         o1.m_disable_floyd_steinberg_dithering !=
             o2.m_disable_floyd_steinberg_dithering ||
